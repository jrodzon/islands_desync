...
from islands_desync.geneticAlgorithm.solution.binary_island_solution import BinaryIslandSolution
from islands_desync.geneticAlgorithm.solution.float_island_solution import FloatIslandSolution
