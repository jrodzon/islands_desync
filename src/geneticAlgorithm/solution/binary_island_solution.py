...
class BinaryIslandSolution(BinarySolution):
    def __init__(self, number_of_variables: int, number_of_objectives: int, number_of_constants: int,
                 variables, objectives, constraints,
                 from_island: int,
                 from_evaluation: int):
        super(BinaryIslandSolution, self).__init__(number_of_variables, number_of_objectives, number_of_constants)
    ...
    def __str__(self) -> str:
        return 'Binary Island Solution(variables={},objectives={},constraints={},from_island={},from_evaluation={})'.format(self.variables, self.objectives,  self.constraints, self.from_island, self.from_evaluation)
