...
from src.geneticAlgorithm.algorithm.genetic_island_algorithm import GeneticIslandAlgorithm
from src.geneticAlgorithm.generator.island_solution_generator import IslandSolutionGenerator
from src.geneticAlgorithm.migrations.ray_migration import RayMigration
from src.geneticAlgorithm.run_hpc.run_algorithm_params import RunAlgorithmParams
from src.geneticAlgorithm.utils import datetimer, myDefCrossover
from src.geneticAlgorithm.utils.myDefMutation import MyUniformMutation


def create_algorithm_hpc(n, island, emigration, params: RunAlgorithmParams) -> GeneticIslandAlgorithm:
    conf_file = 'geneticAlgorithm/algorithm/configurations/algorithm_configuration.json'
    ...
    genetic_island_algorithm = GeneticIslandAlgorithm(
        ...
        mutation=MyUniformMutation(
            1 / (problem.number_of_variables), 10.0),
        # 0.5, 9.0),
        ...
        want_save_diversity_when_improvement=configuration["want_save_diversity_when_improvement"],
