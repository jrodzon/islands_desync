class Checker():
    ...
    def checkSmaller(self, obj1, obj2):    # stare, nowy - gdy nowy jest mniejszy tzn. przyszedł lepszy
    ...
    def checkOutside(self, obj1, obj2, obj3):   # stare_best, stare_worst, nowy
        ...
        if (obj1.objectives[0] <= obj3.objectives[0]) and (obj3.objectives[0] <= obj2.objectives[0]):
            return True
        else:
            return False
    ...
    def checkDiffVarBEST(self, obj1, obj2):  # suma modułów różnic na wymiarach - nowego z najlepszym
        difference = 0
    ...
    def checkDiffGenerations(self,obj1, obj2):  #różnica evaluacji wyspy i przybywającego migranta
