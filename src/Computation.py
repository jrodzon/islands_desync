...
from src.geneticAlgorithm.run_hpc.create_algorithm_hpc import create_algorithm_hpc
...
class Computation:
    ...
    def __init__(self, island, n: int, islands, select_algorithm, algorithm_params: RunAlgorithmParams):
        self.island = island
        self.n: int = n
        ...
        self.algorithm = create_algorithm_hpc(n, island, self.emigration, algorithm_params)
